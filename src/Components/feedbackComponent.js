...
export function Feedback(){
    return(
        ...
        <Form style={{marginTop: "50px"}} onSubmit={(event)=>{alert("Form has been Submitted!");event.preventDefault()}}>
            <Form.Group>
                <Form.Label className="col-12 offset-md-3" style={{paddingLeft: "0px"}}>First Name</Form.Label>
                <Form.Control name="firstname" id="firstname" className="col-12 col-md-6 offset-md-3" type="text"/>
            </Form.Group>
            <Form.Group>
                <Form.Label className="col-12 offset-md-3" style={{paddingLeft: "0px"}}>Last Name</Form.Label>
                <Form.Control name="lastname" id="lastname" className="col-12 col-md-6 offset-md-3" type="text"/>
            </Form.Group>
            <Form.Group>
                <Form.Label className="col-12 offset-md-3" style={{paddingLeft: "0px"}}>Email Address</Form.Label>
                <Form.Control name="email" id="email" className="col-12 col-md-6 offset-md-3" type="email"/>
            </Form.Group>
            <Form.Group>
                <Form.Label className="col-12 offset-md-3" style={{paddingLeft: "0px"}}>Feedback</Form.Label>
